/**
 * Logo Optimization Script V2
 * Creates optimized versions of the adjusted circular DEVOCEAN Lodge logo
 */
...
async function optimizeLogo() {
  const inputPath = 'WebsiteProject/public/images/devocean_logo_circle.png';
  const outputDir = 'WebsiteProject/public/images';
  
  console.log('🎨 Optimizing adjusted DEVOCEAN Lodge logo...\n');
