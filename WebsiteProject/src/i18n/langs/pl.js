export const UI = {
  ...
  hero: { title: "DEVOCEAN Lodge", subtitle: "Ekologiczne pobyty blisko dziewiczej plaży w światowej klasy kierunku pełnym przygód.", description: "Odkryj wyjątkowy raj nurkowy UNESCO, otoczony rezerwatami przyrody i pełen niezapomnianych atrakcji na świeżym powietrzu.", ctaPrimary: "Check Availability", ctaSecondary: "Poznaj lodge", badge: "Komfort i wartość uwielbiane przez gości", clickReviews: "Kliknij opinie!", whyPonta: "Dlaczego Ponta do Ouro?", villageHighlights: "Atrakcje", goDiving: "Nurkowanie" },
