...
menu: "メニュー",
    ...
    contact: { headline: "お問い合わせ", blurb: "即時空室確認と確定料金はオンライン予約をご利用ください。", formHint: "グループ、送迎、特別なご要望にはこのフォームをご使用ください。", call: "WhatsApp", email: "メール", directions: "道順", bookNow: "オンライン予約" },
    form: {
