...
menu: "メニュー",
    ...
    nav: { home: "ホーム", stay: "宿泊", experiences: "Explore Ponta", todo: "アクティビティ", gallery: "ギャラリー", location: "場所", contact: "連絡先", food: "食事" },
    ...
    location: {
      ...
      items: [
        "ポンタ・ド・オウロ村の中心部、ビーチから徒歩数分",
        "地元のレストラン、カフェ、マーケットが近くに",
        "マプトとコシベイ国境からの公共交通機関とプライベート送迎あり",
        "セキュアパーキング。CCTVによる監視",
        "コシベイ国境から車で20分（13km）",
        "コマティポールト国境から車で4時間（210km）",
      ...
      howToFind: {
        ...
        transport: "Lodgeと公共交通機関の乗り場との距離は、短い徒歩または150メートルです。",
      },
    },
...
nav: { home: "ホーム", stay: "宿泊", experiences: "Explore Ponta", todo: "アクティビティ", gallery: "ギャラリー", location: "場所", contact: "連絡先" },
    ...
    experiences: {
      ...
      malongane: { title: "ポンタ・マロンガネ・ビーチウォーク", desc: "インド洋沿いを数時間歩いた後、素朴な村を楽しみましょう。ビーチまたは4×4で帰路。" },
