...
menu: "メニュー",
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "手つかずのビーチ近くのエコフレンドリーな滞在。自然保護区に囲まれた世界クラスのユネスコダイビング目的地。", ctaPrimary: "滞在を予約", ctaSecondary: "ロッジを探検", badge: "ゲストに愛される快適さと価値", whyPonta: "なぜPonta do Ouro？" },
