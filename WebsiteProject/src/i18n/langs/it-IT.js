...
menu: "Menu",
    ...
    experiences: { headline: "Esplora Ponta", blurb: "Avventure tra oceano e foresta a portata di mano.", operators: "Operatori locali fidati:", featured: "In evidenza", learnMore: "Esplora siti di immersione, operatori e prezzi →" },
    units: {
      safari: {
        title: "Tenda Safari",
    ...
    location: {
      ...
      howToFind: {
        ...
        transport: "La distanza tra il Lodge e la fermata del Trasporto Pubblico è una breve passeggiata o solo 150 metri.",
      },
    },
