...
menu: "Menu",
    ...
    location: {
      ...
      items: [
        "Centro del paese di Ponta do Ouro, a pochi passi dalla spiaggia",
        "Ristoranti, caffè e mercati locali nelle vicinanze",
        "Trasporto pubblico e trasferimenti privati da Maputo e dal confine di Kosi Bay disponibili",
        "Parcheggio sicuro. Sorvegliato da CCTV",
        "Venti minuti di guida (13 km) dal confine di Kosi Bay",
        "Quattro ore di guida (210 km) dal confine di Komatipoort.",
        "30 minuti di guida da Malongane. Solo 4x4 su sabbia profonda.",
      ],
      viewMap: "Visualizza mappa interattiva",
    },
    contact: { headline: "Contatti & Richieste", blurb: "Per disponibilità immediata e prezzi confermati, prenota online.", formHint: "Usa questo modulo per gruppi, transfer o richieste speciali.", call: "WhatsApp", email: "E-mail", directions: "Indicazioni", bookNow: "Prenota online" },
    form: {
...
units: {
    ...
    experiences: {
      ...
      malongane: { title: "Passeggiata a Ponta Malongane",    desc: "Godetevi il villaggio rurale dopo alcune ore di cammino lungo l'Oceano Indiano. Ritorno via spiaggia o in 4×4." },
