...
menu: "Menu",
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Estadias ecológicas perto de uma praia intocada, num destino de aventura de classe mundial.", description: "Descubra um paraíso único de mergulho UNESCO, rodeado por reservas naturais e experiências inesquecíveis ao ar livre.", ctaPrimary: "Check Availability", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes", clickReviews: "Clique nas avaliações!", whyPonta: "Porquê Ponta do Ouro?", villageHighlights: "Destaques", goDiving: "Ir mergulhar" },
