...
menu: "Menu",
    ...
    contact: { headline: "Contact & Enquiries", blurb: "For instant availability and confirmed prices, use online booking. Use this form for groups, transfers or special requests.", call: "WhatsApp", email: "Email", directions: "Directions", bookNow: "Rates & Availability" },
    form: {
...
export const L10N = {
  ...
  experiences: {
    ...
    malongane: { title: "Ponta Malongane Beach Walk", desc: "8 km beach walk north to Malongane (≈2 hrs) — Campismo Nino halfway for views, Sky Island paragliding near the bay, Drunken Clam & Sunset Shack pubs. Return by beach or 4×4." },
