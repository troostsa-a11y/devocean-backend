// Translations for en-GB
export const UI = {
menu: "Menu",
    regions: { westEu: "Western Europe", eastEu: "Eastern Europe", asia: "Asia", americas: "Americas", africa: "Africa", oceania: "Oceania" },
    nav: { home: "Home", stay: "Stay", experiences: "Explore Ponta", todo: "What to do", gallery: "Gallery", location: "Location", contact: "Contact", food: "Food" },
    hero: { title: "DEVOCEAN Lodge", subtitle: "Eco-friendly stays near an unspoiled beach in a world-class adventure destination.", description: "Discover a unique UNESCO diving paradise, surrounded by nature reserves and unforgettable outdoor experiences.", ctaPrimary: "Check Availability", ctaSecondary: "Explore the Lodge", badge: "Guests loved comfort & value", clickReviews: "Click the reviews!", villageHighlights: "Village Highlights", goDiving: "Go Diving" },
    ...
    location: {
      ...
      items: [
        "Ponta do Ouro village center, a short walk from the beach",
        "Local restaurants, cafés and markets nearby",
        "Public transport and private transfers from Maputo and Kosi Bay border available",
        "Secure parking. CCTV monitored",
        "Twenty minutes drive (13 km) from Kosi Bay border",
        "Four hour drive (210 km) from Komatipoort border.",
        "30 minutes drive from Malongane. 4x4 over deep sand only.",
      ],
      viewMap: "View Interactive Map",
      howToFind: {
        heading: "Where to find DEVOCEAN Lodge?",
        steps: [
          "Enter the village over the new tar road.",
          "Pass the local market on the left and move up the little hill.",
          "Turn right into Rua C, immediately after Love Café.",
          "You'll find us after 100 meters on the right.",
        ],
        note: "DEVOCEAN Lodge is accessible for all types of cars and motor bikes.",
        transport: "The distance between the Lodge and the Public Transport station is a short walk or 150 meters only.",
      },
    },
    contact: { headline: "Contact & Enquiries", blurb: "For instant availability and guaranteed prices, click the Online Booking button in the top of the page.", formHint: "Use this form for transfers, groups or special requests.", call: "WhatsApp", email: "Email", directions: "Directions", bookNow: "Online Booking" },
    form: {
...
export const L10N = {
  units: {
    safari: {
      ...
      details: [
        ...
        "Safari Tent guests use shared bathroom facilities with separate women's and men's sections. Each section has two toilets and two showers.",
        "Village can be lively during holidays; free earplugs at reception",
      ],
    },
    comfort: {
      title: "Comfort Tent",
      short: "Upgraded 12 m² tent with extra privacy (side/back walls), private terrace and your own private en-suite bathroom in an adjoining thatched rondavel.",
      details: [
        ...
        "Your private bathroom is housed in an adjoining thatched rondavel, reached from the tent's rear door via a short private connection.",
        "Village liveliness during peak/holidays; earplugs available",
      ],
    },
    cottage: {
      title: "Garden Cottage",
      short: "Airy cottage with queen bed, AC Inverter for cooling & heating, desk & dining table, private terrace and en-suite bathroom in an adjoining thatched rondavel.",
      details: [
        ...
        "Your private en-suite bathroom is housed in an adjoining thatched rondavel and accessed directly through the bedroom's rear door.",
    ...
    chalet: {
      ...
      details: [
        ...
        "En-suite bathroom (shower, sink, toilet)",
  ...
  experiences: {
    ...
    malongane: { title: "Ponta Malongane Beach Walk", desc: "Enjoy the rural village after a few hours walking side by side with the Indian Ocean. Return by beach or 4×4." },
