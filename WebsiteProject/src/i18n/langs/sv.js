export const UI = {
  ...
  nav: { home: "Hem", stay: "Boende", experiences: "Utforska Ponta", todo: "Att göra", gallery: "Galleri", location: "Plats", contact: "Kontakt", food: "Mat" },
  hero: { title: "DEVOCEAN Lodge", subtitle: "Miljövänligt boende nära en orörd strand i en äventyrsdestination i världsklass.", description: "Upptäck ett unikt UNESCO-dykparadis, omgivet av naturreservat och oförglömliga upplevelser utomhus.", ctaPrimary: "Kontrollera tillgänglighet", ctaSecondary: "Utforska lodgen", badge: "Gästernas favorit – komfort och värde", clickReviews: "Klicka på recensionerna!", whyPonta: "Varför Ponta do Ouro?", villageHighlights: "Höjdpunkter", goDiving: "Dyk" },
  ...
  experiences: { headline: "Utforska Ponta", blurb: "Havs- och skogsäventyr precis utanför dörren.", operators: "Pålitliga lokala arrangörer:", featured: "Utvalda", learnMore: "Utforska dykplatser, arrangörer och priser →" },
  todo: {
  ...
  location: {
    ...
    howToFind: {
      heading: "Var hittar du DEVOCEAN Lodge?",
      steps: [
        "Kör in i byn via den nya asfalterade vägen.",
        "Passera den lokala marknaden till vänster och kör uppför den lilla kullen.",
        "Sväng höger in i Rua C, direkt efter Love Café.",
...
export const L10N = {
  ...
  experiences: {
    ...
    malongane: { title: "Strandpromenad till Ponta Malongane", desc: "Njut av den lantliga byn efter några timmars vandring längs Indiska oceanen. Återvänd via stranden eller med 4×4." },
