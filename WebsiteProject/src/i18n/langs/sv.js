export const UI = {
  ...
  hero: { title: "DEVOCEAN Lodge", subtitle: "Miljövänligt boende nära en orörd strand i en äventyrsdestination i världsklass.", description: "Upptäck ett unikt UNESCO-dykparadis, omgivet av naturreservat och oförglömliga upplevelser utomhus.", ctaPrimary: "Check Availability", ctaSecondary: "Utforska lodgen", badge: "Gästernas favorit – komfort och värde", clickReviews: "Klicka på recensionerna!", whyPonta: "Varför Ponta do Ouro?", villageHighlights: "Höjdpunkter", goDiving: "Dyk" },
