export const UI = {
  ...
  experiences: { headline: "Gundua Ponta", blurb: "Matukio ya baharini na msituni yapo karibu na mlango wako.", operators: "Watoa huduma wa ndani wanaotegemewa:", featured: "Maarufu", learnMore: "Chunguza maeneo ya kupiga mbizi, watoa huduma na bei →" },
  todo: {
...
export const L10N = {
  ...
  experiences: {
    ...
    malongane: { title: "Matembezi ya Ponta Malongane",     desc: "Furahia kijiji cha vijijini baada ya masaa machache ya kutembea kando ya Bahari Hindi. Rudi pwani au 4×4." },
