export const UI = {
  ...
  hero: { title: "DEVOCEAN Lodge", subtitle: "Экологичное проживание у первозданного пляжа. Мировой центр дайвинга под эгидой ЮНЕСКО, окружённый природными заповедниками.", ctaPrimary: "Забронировать проживание", ctaSecondary: "Ознакомиться с лоджем", badge: "Комфорт и ценность, любимые гостями", whyPonta: "Почему Ponta do Ouro?" },
