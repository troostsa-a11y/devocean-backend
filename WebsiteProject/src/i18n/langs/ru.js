export const UI = {
  ...
  contact: { headline: "Контакты и запросы", blurb: "Для мгновенной доступности и подтверждённых цен бронируйте онлайн. Эта форма предназначена для групп, трансферов или особых пожеланий.", call: "WhatsApp", email: "Электронная почта", directions: "Как добраться", bookNow: "Цены и наличие" },
  form: {
...
export const L10N = {
  experiences: {
    ...
    malongane: { title: "Прогулка на пляж Понта-Малонгане", desc: "8 км по пляжу до Малонгане (≈2 ч) — Campismo Nino на полпути с видом, параплан на Sky Island, бары Drunken Clam & Sunset Shack. Возврат по пляжу или на 4×4." },
