export const UI = {
  ...
  nav: { home: "Главная", stay: "Проживание", experiences: "Исследуй Понту", todo: "Чем заняться", gallery: "Галерея", location: "Местоположение", contact: "Контакты" },
  hero: { title: "DEVOCEAN Lodge", subtitle: "Экологичный отдых рядом с нетронутым пляжем в месте для приключений мирового класса.", description: "Откройте для себя уникальный рай для дайвинга ЮНЕСКО, окружённый природными заповедниками и незабываемыми возможностями для отдыха на природе.", ctaPrimary: "Забронировать проживание", ctaSecondary: "Ознакомиться с лоджем", badge: "Комфорт и ценность, любимые гостями", clickReviews: "Нажмите на отзывы!", whyPonta: "Почему Ponta do Ouro?", villageHighlights: "Хайлайты", goDiving: "На дайвинг" },
