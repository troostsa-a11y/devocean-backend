export const UI = {
  ...
  experiences: { headline: "Исследуй Понту", blurb: "Приключения на море и в лесу прямо у вашего порога.", operators: "Надежные местные операторы:", learnMore: "Исследуйте места для дайвинга, операторов и цены →" },
  todo: {
