export const UI = {
  ...
  contact: { headline: "Контакты и запросы", blurb: "Для мгновенной доступности и подтверждённых цен бронируйте онлайн.", formHint: "Эта форма предназначена для групп, трансферов или особых пожеланий.", call: "WhatsApp", email: "Электронная почта", directions: "Как добраться", bookNow: "Цены и наличие" },
  form: {
