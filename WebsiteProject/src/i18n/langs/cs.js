export const UI = {
  ...
  hero: { title: "DEVOCEAN Lodge", subtitle: "Ekologické ubytování u nedotčené pláže ve světoznámé destinaci pro dobrodružství.", description: "Objevte jedinečný potápěčský ráj UNESCO obklopený přírodními rezervacemi a nezapomenutelnými zážitky v přírodě.", ctaPrimary: "Check Availability", ctaSecondary: "Prozkoumejte lodge", badge: "Pohodlí a hodnota, kterou hosté chválí", clickReviews: "Klikněte na recenze!", whyPonta: "Proč Ponta do Ouro?", villageHighlights: "Zajímavosti vesnice", goDiving: "Jděte se potápět" },
