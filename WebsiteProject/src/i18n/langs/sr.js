export const UI = {
  ...
  nav: { home: "Početna", stay: "Smeštaj", experiences: "Istraži Pontu", todo: "Šta raditi", gallery: "Galerija", location: "Lokacija", contact: "Kontakt", food: "Hrana" },
  hero: { title: "DEVOCEAN Lodge", subtitle: "Ekološki smeštaj pored netaknute plaže u svetski poznatoj destinaciji za avanture.", description: "Otkrijte jedinstveni UNESCO ronilački raj okružen prirodnim rezervatima i nezaboravnim doživljajima u prirodi.", ctaPrimary: "Proverite dostupnost", ctaSecondary: "Istražite lodge", badge: "Udobnost i vrednost koje gosti hvale", clickReviews: "Kliknite na recenzije!", whyPonta: "Zašto Ponta do Ouro?", villageHighlights: "Atrakcije sela", goDiving: "Idite na ronjenje" },
  ...
  todo: {
    ...
    items: [
      { title: "Šetnja do Svetionika i Lua Do Mar", body: "Popnite se do Starog svetionika za panoramske poglede. Nastavite do restorana Lua Do Mar na dini. Često ćete videti delfine tokom cele godine, kitove (maj–oktobar) i kornjače (decembar–januar). Pazite na plimu: izbegavajte plažni put 3 sata pre i 3 sata posle plime; nepredviđeni talasi mogu vas baciti na stene." },
      { title: "Šetnja do Ponta Malongane", body: "Hodajte plažom duž obale do susednog sela. Na pola puta, stepenice među bananama vode do paba i restorana Campismo Nino sa lepim pogledom. Blizu prelaza ka uvali, staza ka Sky Island nudi paragliding. Poznati pabovi u Malongane: Drunken Clam i Sunset Shack. Vratite se plažom ili 4×4 peščanim putem." },
      { title: "Surfovanje, ronjenje i okeanska istraživanja", body: "Iznajmljivanje surf dasaka u Beach Bar-u; više ronilačkih centara u selu, plus istraživački centar za delfine i kitove." },
  ...
  location: {
    ...
    items: [
      ...
      "Lokalni restorani, kafići i pijace u blizini",
      "Javni prevoz i privatni transferi iz Maputoa i granice Kosi Bay dostupni",
      ...
      "30 minuta vožnje od Malongane. Samo 4x4 po dubokom pesku.",
    ],
    viewMap: "Pogledajte interaktivnu mapu",
    howToFind: {
      heading: "Где пронаћи DEVOCEAN Lodge?",
      steps: [
        "Уђите у село новим асфалтираним путем.",
        "Прођите поред локалне пијаце са леве стране и идите уз мали брежуљак.",
        "Скрените десно у Rua C, одмах после Love Café.",
  ...
  form: {
    name: "Ime", email: "Imejl", stayLabel: "Zainteresovan za smeštaj:", checkin: "Od (prijava)", checkout: "Do (odjava)",
    ...
    success: "Hvala! Vaša poruka je poslata. Proverite imejl za potvrdu.",
...
export const L10N = {
  units: {
    safari: {
      title: "Safari Šator",
      short: "Platneni šator 12 m² na platformi 3×6 m. Twin ili king kreveti, ventilator, utičnice, mreža protiv komaraca, privatna terasa. Zajednička kupatila.",
      details: [
        "Dva kreveta (ili King) s noćnim ormarićima i lampama za čitanje",
        "Mreža protiv komaraca • snažan ventilator • utičnice",
        "Privatna terasa sa palmovim stolicama",
        "Zajednički objekti: topli/hladni tuševi i toaleti — odeljenja za žene i muškarce, 2 toaleta + 2 tuša svaki",
      ],
    },
    comfort: {
      title: "Comfort Šator",
      short: "Unapređeni šator 12 m² s dodatnom privatnošću (bočni/zadnji zidovi), privatnom terasom i privatnim kupatilom u susednom rondavelu pod slamnatim krovom.",
      details: [
        "Twin ili king raspored s praktičnim osvetljenjem",
        "Mreža protiv komaraca • snažan ventilator • utičnice",
        "Privatna terasa sa stolicama",
        "Vaše privatno kupatilo nalazi se u susednom rondavelu pod slamnatim krovom, dostupno zadnjim vratima šatora kroz kratku privatnu vezu.",
      ],
    },
    cottage: {
      title: "Vikendica sa Baštom",
      short: "Prostrana vikendica s king krevetom, inverter klimom, radnim i trpezarijskim stolom, privatnom terasom i en-suite kupatilom u susednom rondavelu pod slamnatim krovom.",
      details: [
        "King krevet • radni i trpezarijski sto",
        "Inverter klima • prigušivo svetlo",
        "Vaše privatno en-suite kupatilo nalazi se u susednom rondavelu pod slamnatim krovom, direktno dostupno zadnjim vratima spavaće sobe.",
        "Privatna terasa sa stolicama",
      ],
    },
    chalet: {
      title: "Kućica sa Slamnatim Krovom",
      short: "Romantična kućica pod palmama. Inverter klima, en-suite kupatilo, terasa, twin ili king krevet.",
      details: [
        "Mirno mesto pod palmama • klima uređaj",
        "En-suite kupatilo (tuš, umivaonik, toalet)",
  ...
  experiences: {
    ...
    dolphins: { title: "Plivanje sa delfinima", desc: "Etički susreti sa rezidentnim delfinima." },
    ...
    malongane: { title: "Šetnja do Ponta Malongane",        desc: "Uživajte u ruralnom selu nakon nekoliko sati šetnje uz Indijski okean. Povratak plažom ili 4×4." },
