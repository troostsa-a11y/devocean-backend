export const UI = {
  ...
  contact: { headline: "Kontakt i upiti", blurb: "Za trenutnu dostupnost i potvrđene cene, rezervišite online. Koristite ovaj formular za grupe, transfere ili posebne zahteve.", call: "WhatsApp", email: "Imejl", directions: "Uputstva za put", bookNow: "Cene i dostupnost" },
  form: {
...
export const L10N = {
  experiences: {
    ...
    malongane: { title: "Šetnja do Ponta Malongane",        desc: "8 km šetnje plažom do Malongane (≈2 sata) — Campismo Nino na pola puta s pogledom, paraglajding na Sky Island, pabovi Drunken Clam & Sunset Shack. Povratak plažom ili 4×4." },
