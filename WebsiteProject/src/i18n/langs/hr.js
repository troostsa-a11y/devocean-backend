export const UI = {
  ...
  contact: { headline: "Kontakt i upiti", blurb: "Za trenutnu dostupnost i potvrđene cijene, rezervirajte online.", formHint: "Koristite ovaj obrazac za grupe, transfere ili posebne zahtjeve.", call: "WhatsApp", email: "Imejl", directions: "Uputstva za put", bookNow: "Cene i dostupnost" },
  form: {
