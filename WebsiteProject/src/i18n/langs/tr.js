export const UI = {
  ...
  nav: { home: "Ana Sayfa", stay: "Konaklama", experiences: "Ponta'yı Keşfet", todo: "Yapılacaklar", gallery: "Galeri", location: "Konum", contact: "İletişim", food: "Yemek" },
  hero: { title: "DEVOCEAN Lodge", subtitle: "Dünyaca ünlü bir macera bölgesinde, bozulmamış bir plajın yanında çevre dostu konaklama.", description: "Doğa rezervleri ve unutulmaz vahşi yaşam deneyimleriyle çevrili eşsiz bir UNESCO dalış cennetini keşfedin.", ctaPrimary: "Müsaitliği Kontrol Et", ctaSecondary: "Lodge'u Keşfedin", badge: "Misafirlerin övdüğü konfor ve değer", clickReviews: "Yorumlara tıklayın!", whyPonta: "Neden Ponta do Ouro?", villageHighlights: "Köy Cazibeleri", goDiving: "Dalışa Gidin" },
