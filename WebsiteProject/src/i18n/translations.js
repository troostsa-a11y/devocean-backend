...
export const UI = {
  "en-GB": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Eco-friendly stays near an unspoiled beach in a world-class diving destination.", description: "Discover a unique UNESCO diving destination surrounded by nature reserves, just a short stroll from an unspoiled beach.", ctaPrimary: "Book your Stay", ctaSecondary: "Explore the Lodge", badge: "Guests loved comfort & value", villageHighlights: "Village Highlights", goDiving: "Go Diving" },
  ...
  "nl-NL": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Eco-vriendelijke accommodaties nabij een ongerept strand. Een UNESCO-duikbestemming van wereldklasse omgeven door natuurreservaten.", ctaPrimary: "Boek je verblijf", ctaSecondary: "Verken de lodge", badge: "Geliefd om comfort & prijs-kwaliteit" },
