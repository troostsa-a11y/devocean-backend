...
export const UI = {
  "en-GB": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Eco-friendly stays near an unspoiled beach in a world-class adventure destination.", description: "Discover a unique UNESCO diving paradise, surrounded by nature reserves and unforgettable outdoor experiences.", ctaPrimary: "Check Availability", ctaSecondary: "Explore the Lodge", badge: "Guests loved comfort & value", villageHighlights: "Village Highlights", goDiving: "Go Diving" },
  ...
  "pt-PT": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Estadias ecológicas perto de uma praia intocada, num destino de aventura de classe mundial.", description: "Descubra um paraíso único de mergulho UNESCO, rodeado por reservas naturais e experiências inesquecíveis ao ar livre.", ctaPrimary: "Check Availability", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes", whyPonta: "Porquê Ponta do Ouro?" },
    ...
    todo: {
      ...
      items: [
        { title: "Caminhada ao farol e Lua Do Mar", body: "Caminhe até ao Antigo Farol para vistas panorâmicas. Continue até ao Restaurante Lua Do Mar na duna. Muitas vezes aviste golfinhos durante todo o ano, baleias (maio–outubro) e tartarugas (dezembro–janeiro). Atenção à maré: evite a rota da praia de 3 horas antes a 3 horas após a maré alta; ondas imprevisíveis podem empurrá-lo contra as rochas." },
        { title: "Caminhada até Ponta Malongane", body: "Caminhada pela praia ao longo da costa até à próxima aldeia. A meio caminho, escadas através de bananeiras em machambas levam ao Pub & Restaurante Campismo Nino com ótimas vistas. Perto da transição da baía, um caminho para Sky Island oferece parapente. Pubs famosos em Malongane: Drunken Clam e Sunset Shack. Regresso pela praia ou pela estrada arenosa 4×4." },
        { title: "Surf, mergulho e pesquisa oceânica", body: "Aluguer de pranchas de surf no Beach Bar; vários centros de mergulho na aldeia e um centro de pesquisa de golfinhos/baleias." },
        { title: "Comer e relaxar nas proximidades", body: "Há cerca de 16 pubs e restaurantes dentro de 500 m do DEVOCEAN. Para uma massagem relaxante de corpo inteiro, pergunte por Lisa (LIZ-Way Massage)." },
        { title: "Aluguer de quadriciclos", body: "Alugueres privados ocasionais de locais. Taxa típica: cerca de 2000 MZN por hora (negociação varia)." },
      ],
    },
    ...
    location: {
      ...
      items: [
        "Cidade de Ponta do Ouro, a uma curta caminhada da praia",
        "15 min até Ponta Malongane • 25 min até à fronteira de Kosi Bay",
        "Estacionamento seguro • Cafés e mercados locais nas proximidades",
      ],
    ...
    form: {
      ...
      units: [
        "Tenda Safari - casa de banho partilhada",
        "Tenda Conforto - casa de banho privada",
        "Cottage de Jardim - AC inversor",
        "Chalé de Palha - AC inversor"
      ],
      message: "Mensagem", send: "Enviar",
      consent: "Ao submeter, concorda em ser contactado sobre a sua consulta.",
      phName: "O seu nome", phEmail: "seu@email.com", phDate: "dd/mm/aaaa", phMsg: "Conte-nos mais sobre os seus desejos...",
      success: "Obrigado! A sua mensagem foi enviada. Verifique o seu e-mail para confirmação.",
    },
  ...
  "pt-BR": {
    ...
    nav: { home: "Início", stay: "Estadia", experiences: "Experiências", todo: "O que fazer", gallery: "Galeria", location: "Localização", contact: "Contacto" },
    hero: { title: "DEVOCEAN Lodge", subtitle: "Hospedagens ecológicas perto de uma praia intocada, em um destino de aventura de classe mundial.", description: "Descubra um paraíso único de mergulho da UNESCO, cercado por reservas naturais e experiências inesquecíveis ao ar livre.", ctaPrimary: "Check Availability", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes", whyPonta: "Porquê Ponta do Ouro?" },
    stay: { headline: "Fique connosco", blurb: "Escolha o seu estilo: tendas imersas na natureza ou chalés e cottage aconchegantes – tudo com hospitalidade familiar calorosa, como numa machamba local.", moreDetails: "Mais detalhes", ourStory: "A Nossa História" },
    experiences: { headline: "Experiências", blurb: "Aventuras no oceano e na floresta mesmo à sua porta.", operators: "Operadores locais de confiança:" },
    todo: {
      headline: "O que fazer em Ponta do Ouro",
  ...
  "nl-NL": {
    ...
    form: {
      ...
      units: [
        "Safari Tent - gedeelde badkamer",
        "Comfort Tent - eigen badkamer",
        "Tuincottage - inverter AC",
        "Rieten Chalet - inverter AC"
      ],
      message: "Bericht", send: "Verzenden",
      consent: "Door te verzenden ga je akkoord dat we contact met je opnemen over je aanvraag.",
      phName: "Je naam", phEmail: "jij@email.com", phDate: "dd/mm/jjjj", phMsg: "Vertel ons meer over je wensen...",
  ...
  "fr-FR": {
    ...
    form: {
      ...
      checkin: "Du",
      checkout: "Au",
      unitLabel: "Mon hébergement préféré est :",
      units: [
        "Tente Safari - salle de bain partagée",
        "Tente Confort - salle de bain privée",
        "Cottage Jardin - climatisation inverter",
        "Chalet en chaume - climatisation inverter"
      ],
      message: "Message",
      send: "Envoyer",
      consent:
      ...
      phDate: "jj/mm/aaaa",
      phMsg: "Parlez-nous de vos souhaits...",
  ...
  "it-IT": {
    ...
    form: {
      ...
      units: [
        "Tenda Safari - bagno condiviso",
        "Tenda Comfort - bagno privato",
        "Cottage Giardino - AC inverter",
        "Chalet di paglia - AC inverter"
      ],
      message: "Messaggio", send: "Invia",
      consent: "Inviando accetti di essere contattato riguardo alla tua richiesta.",
      phName: "Il tuo nome", phEmail: "tu@email.com", phDate: "gg/mm/aaaa", phMsg: "Raccontaci i tuoi desideri...",
  ...
  "de-DE": {
    ...
    form: {
      ...
      units: [
        "Safari Zelt - gemeinsames Bad",
        "Komfort Zelt - privates Bad",
        "Garten Cottage - Inverter-Klimaanlage",
        "Strohdach Chalet - Inverter-Klimaanlage"
      ],
      message: "Nachricht", send: "Senden",
      consent: "Mit dem Absenden stimmen Sie zu, kontaktiert zu werden.",
      phName: "Ihr Name", phEmail: "sie@email.com", phDate: "tt/mm/jjjj", phMsg: "Erzählen Sie uns mehr über Ihre Wünsche...",
  ...
  "es-ES": {
    ...
    form: {
      ...
      units: [
        "Tienda Safari - baño compartido",
        "Tienda Confort - baño privado",
        "Cabaña Jardín - AC inverter",
        "Chalet de paja - AC inverter"
      ],
      message: "Mensaje", send: "Enviar",
      consent: "Al enviar, aceptas que te contactemos.",
      phName: "Tu nombre", phEmail: "tu@email.com", phDate: "dd/mm/aaaa",
      phMsg: "Cuéntanos más sobre tus deseos...",
  ...
  sv: {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Miljövänligt boende nära en orörd strand i en äventyrsdestination i världsklass.", description: "Upptäck ett unikt UNESCO-dykparadis, omgivet av naturreservat och oförglömliga upplevelser utomhus.", ctaPrimary: "Check Availability", ctaSecondary: "Utforska lodgen", badge: "Gästernas favorit – komfort och värde" },
    ...
    form: {
      ...
      phName: "Ditt namn", phEmail: "din@epost.se", phDate: "dd/mm/åååå", phMsg: "Berätta mer om dina önskemål...",
  ...
  pl: {
    ...
    form: {
      ...
      phName: "Twoje imię", phEmail: "twoj@email.com", phDate: "dd/mm/rrrr", phMsg: "Opowiedz nam więcej o swoich życzeniach...",
  ...
  "ja-JP": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "手つかずのビーチのそばで楽しむ、世界級のアドベンチャーデスティネーションにあるエコフレンドリーな滞在。", description: "自然保護区に囲まれた、忘れられないアウトドア体験が待つ、ユネスコ認定の特別なダイビングパラダイスを発見してください。", ctaPrimary: "Check Availability", ctaSecondary: "ロッジを探検", badge: "ゲストに愛される快適さと価値" },
    ...
    form: {
      ...
      phName: "お名前", phEmail: "メール@example.jp", phDate: "日/月/年", phMsg: "ご希望について詳しくお知らせください...",
  ...
  "zh-CN": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "在世界级探险胜地，享受邻近原始海滩的环保住宿。", description: "探索独一无二的联合国教科文组织潜水天堂，四周环绕自然保护区，并可体验难忘的户外活动。", ctaPrimary: "Check Availability", ctaSecondary: "探索旅馆", badge: "深受宾客喜爱的舒适与价值" },
    ...
    form: {
      ...
      phName: "您的姓名", phEmail: "您的@email.cn", phDate: "日/月/年", phMsg: "告诉我们更多您的愿望...",
  ...
  "af-ZA": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Omgewingsvriendelike verblyf naby 'n ongerepte strand in 'n wêreldklas-avontuurbestemming.", description: "Ontdek 'n unieke UNESCO-duikparadys, omring deur natuurreservate en onvergeetlike buitelugervarings.", ctaPrimary: "Check Availability", ctaSecondary: "Verken die Lodge", badge: "Gerief en waarde, geliefd deur gaste" },
    ...
    todo: {
      ...
      items: [
        { title: "Stap na die vuurtoring en Lua Do Mar", body: "Stap na die Ou Vuurtoring vir panoramiese uitsigte. Gaan voort na die Lua Do Mar restaurant op die duin. Dolfyne word dikwels deur die jaar gesien, walvisse (Mei–Oktober) en skilpaaie (Desember–Januarie). Wees bedag op getye: vermy die strandroete 3 uur voor en na hooggety; golwe kan jou teen die rotse vasdruk." },
        { title: "Stap na Ponta Malongane", body: "Stap langs die strand na die aangrensende dorpie. Halfpad lei 'n trap deur piesangbome na die Campismo Nino kroeg en restaurant met uitstekende uitsigte. Nader aan die baai is daar 'n pad na Sky Island vir sweefvlieg. Bekende kroeë in Malongane: Drunken Clam en Sunset Shack. Keer terug via die strand of die 4×4 sandpad." },
        { title: "Branderplankry, duik en see-ondersoeke", body: "Huur branderplanke by Beach Bar; verskeie duiksentrums in die dorpie en 'n dolfyn-/walvis-navorsingsentrum." },
        { title: "Eet en ontspan naby", body: "Binne 500 m van DEVOCEAN is daar ongeveer 16 kroeë en restaurante. Vir 'n ontspannende vollyfmassering, bespreek by Lisa (LIZ-Way Massage)." },
        { title: "Vierwielmotorfietsverhuring", body: "Soms beskikbaar by plaaslike privaatverhuurders. Gewone tarief: ongeveer MZN 2000 per uur (prys afhanklik van onderhandeling)." },
      ],
    },
    gallery: { headline: "Galery" },
    galleryHeading: "Galery",
    location: {
      headline: "Ligging",
      blurb: "Ponta do Ouro — Matutuine-distrik, Suid-Mosambiek.",
      items: [
        "Ponta do Ouro dorpie, minute se stap vanaf die strand",
        "15 minute na Ponta Malongane • 25 minute na Kosi Bay-grens",
        "Veilige parkering • Plaaslike kafees en markte naby",
      ],
    ...
    form: {
      ...
      unitLabel: "Voorkeur kamer tipe:",
      units: ["Safari Tent — gedeelde badkamer", "Comfort Tent — privaat badkamer", "Tuin Kothuis — inverter lugversorger", "Rietdak Chalet — inverter lugversorger"],
      message: "Boodskap", send: "Stuur",
      consent: "Deur die vorm in te dien, stem jy in tot kontak rakende jou navraag.",
      phName: "Jou naam", phEmail: "jou@epos.com", phDate: "dd/mm/jjjj", phMsg: "Vertel ons meer oor jou versoeke...",
      success: "Dankie! Jou boodskap is gestuur. Kyk jou e-pos vir bevestiging.",
    },
    footer: {
      rights: "Alle regte voorbehou.",
      desc: "Gesinsvriendelike eko-gasvryheid en gemeenskapsprojekte in Suid-Mosambiek.",
    },
    currencies: {
      USD: "Dollar",
      JPY: "Yen",
    ...
    legal: {
      ...
      terms: "Voorwaardes en Bepalings",
      gdpr: "GDPR Inligting",
  ...
  zu: {
    ...
    todo: {
      ...
      items: [
        { title: "Ukuhamba ngezinyawo kuya eLighthouse kanye neLua Do Mar", body: "Hamba uye esibani esidala ukuze ujabulele ukubukwa kwe-panorama. Qhubeka uye endaweni yokudlela iLua Do Mar esidunjini. Amadophini avame ukubonakala unyaka wonke, amahhashi ngoMeyi kuya ku-Okthoba, kanye nezimfudu ngoDisemba kuya kuJanuwari. Qaphela amagagasi: gwema umzila wolwandle ezinsukwini ezi-3 ngaphambi nangemuva kwegagasi eliphezulu; amagagasi angase akuphushele emadwaleni." },
        { title: "Ukuhamba ngezinyawo kuya ePonta Malongane", body: "Hamba ngasogwini uye edolobhaneni elilandelayo. Phakathi nendlela, izitebhisi ezidlula ehlathini lobhanana ziholela ebha kanye nendawo yokudlela iCampismo Nino enokubukwa okuhle. Eduze kwe-bay transition, kukhona indlela eya eSky Island yokuparagliding. Amabha adumile eMalongane: iDrunken Clam kanye neSunset Shack. Buyela emuva nge-beach noma ngomgwaqo wesihlabathi we-4×4." },
        { title: "Ukushushuluza, ukushayela ngaphansi kwamanzi kanye nocwaningo lwasolwandle", body: "I-Beach Bar inikeza ukuqashwa kwamabhodi okushushuluza; izikhungo zokushayela ngaphansi kwamanzi eziningi edolobheni kanye nesikhungo socwaningo lwamadophini/amahhashi." },
        { title: "Ukudla kanye nokuphumula eduze", body: "Ngaphakathi kwe-500m ye-DEVOCEAN kunezindawo zokudlela kanye namabha angaba yizi-16. Uma ufuna ukumassaja okupholile komzimba wonke, bhukha noLisa (LIZ-Way Massage)." },
        { title: "Ukuqashwa kwezithuthuthu ezinezinyawo", body: "Ngezikhathi ezithile abantu bendawo banikeza ukuqasha okuzimele. Intengo ejwayelekile: cishe i-MZN 2000 ngehora (kuye ngokuxoxisana)." },
      ],
    },
    gallery: { headline: "Igalari" },
    galleryHeading: "Igalari",
    location: {
      headline: "Indawo",
      blurb: "IPonta do Ouro - isifunda saseMatutuine, eNingizimu yeMozambique.",
      items: [
        "Idolobha lasePonta do Ouro, uhamba ngeminyango uya ogwini",
        "Imizuzu eyi-15 ukuya ePonta Malongane • Imizuzu eyi-25 ukuya emngceleni weKosi Bay",
        "Indawo yokupaka ephephile • Amakhefi endawo kanye nezimakethe ziseduze",
      ],
    ...
    form: {
      ...
      unitLabel: "Uhlobo lwegumbi engiluthandayo:",
      units: ["Itende leSafari - igumbi lokugezela elabiwe", "Itende lokunethezeka - igumbi lokugezela elizimele", "Indlu yasegadini - isiphephetha-moya esiguqukayo", "I-Chalet enotshani - isiphephetha-moya esiguqukayo"],
      message: "Umyalezo", send: "Thumela",
      consent: "Ngokuthumela, uyavuma ukuthi sixhumane nawe mayelana nombuzo wakho.",
      phName: "Igama lakho", phEmail: "your@email.com", phDate: "dd/mm/yyyy", phMsg: "Sitshele kabanzi ngezifiso zakho...",
      success: "Siyabonga! Umyalezo wakho uthunyelwe. Hlola i-imeyili yakho ukuze uthole isiqinisekiso.",
    },
    footer: {
      rights: "Zonke izivakashi zigodliwe.",
      desc: "Ukungenisa izihambi okunobungani bemvelo kanye nemiklamo yomphakathi eNingizimu yeMozambique.",
    },
    currencies: {
      USD: "US-Dollar",
      JPY: "Yen",
    ...
    legal: {
      ...
      cookies: "Inqubomgomo yama-Cookie",
      terms: "Imigomo kanye nezimo",
...
export const L10N = {
  ...
  sv: {
    ...
    experiences: {
      diving: { title: "Dykning", desc: "Offshore-rev med rikt marint liv." },
      dolphins: { title: "Delfinsim", desc: "Etiska möten med lokala delfiner." },
      lighthouse: { title: "Fyrvandring", desc: "Klättra upp till gamla fyren för panoramautsikt." },
  ...
  "ja-JP": {
    ...
    units: {
      safari: {
        title: "サファリテント",
        short: "自然に囲まれた基本的な快適さ。共有バスルーム、ツイン/クイーンベッド。",
        details: [
    ...
    experiences: {
      diving: { title: "ダイビング", desc: "豊かな海洋生物のいる沖合のリーフ。" },
      dolphins: { title: "イルカと泳ぐ", desc: "地元のイルカとの倫理的な出会い。" },
      lighthouse: { title: "灯台ハイク", desc: "パノラマビューのために丘の上の古い灯台に登る。" },
  ...
  "zh-CN": {
    ...
    experiences: {
      diving: { title: "潜水", desc: "海洋生物丰富的近海珊瑚礁。" },
      dolphins: { title: "与海豚游泳", desc: "与当地海豚的合乎道德的接触。" },
      lighthouse: { title: "灯塔远足", desc: "爬上山丘到古老灯塔欣赏全景。" },
      seafari: { title: "海洋探险", desc: "观鯨（5月-10月）等海洋探险。" },
    ...
    todo: {
      ...
      note: "有关潜水、浮潜、 dolphin/whale seafaris 和 fishing charters，请查看以下提供商。",
      items: [
        { title: "灯塔徒步与 Lua Do Mar", body: "徒步前往老灯塔，欣赏全景。继续前往沙丘上的 Lua Do Mar 餐厅。全年常可看到海豚，5 月至 10 月有鲸鱼，12 月至 1 月有海龟。请注意潮汐：高潮前后 3 小时避免走海滩路线；巨浪可能将您推向岩石。" },
        { title: "步行至蓬塔马隆加内", body: "沿海岸步行至下一个村庄。中途经过香蕉树林的楼梯通往 Campismo Nino 酒吧餐厅，景色优美。靠近海湾过渡处，有通往 Sky Island 的路径，可进行滑翔伞运动。马隆加内的著名酒吧：Drunken Clam 和 Sunset Shack。可通过海滩或沙地 4×4 道路返回。" },
        { title: "冲浪、潜水与海洋研究", body: "Beach Bar 提供冲浪板租赁；村庄内有多个潜水中心和海豚/鲸鱼研究中心。" },
        { title: "附近用餐与放松", body: "DEVOCEAN 500 米范围内有约 16 家酒吧和餐厅。想要放松的全身按摩，请预约 Lisa（LIZ-Way Massage）。" },
        { title: "四轮摩托车租赁", body: "当地人偶尔提供私人租赁。典型价格：约 MZN 2000/小时（视谈判而定）。" },
      ],
    },
    gallery: { headline: "图库" },
    galleryHeading: "图库",
  ...
  zu: {
    ...
    experiences: {
      diving: { title: "Ukudayiva", desc: "Ama-reef angaphesheya kolwandle anezilwane zasolwandle ezinhlobonhlobo." },
      dolphins: { title: "Ukubhukuda Namadophini", desc: "Ukuhlangana okunobulungisa namadophini abahlala khona." },
      lighthouse: { title: "Ukuqwala Intaba yeLighthouse", desc: "Khuphuka igquma uye etiyeni elidala lesibane ukuze uthole umbono omkhulu." },
