...
export const UI = {
  ...
  pt: {
    nav: { home: "Início", stay: "Alojamento", experiences: "Experiências", todo: "O que fazer", gallery: "Galeria", location: "Localização", contact: "Contacto" },
    hero: { title: "DEVOCEAN Lodge", subtitle: "Alojamentos ecológicos a poucos metros da praia em Ponta do Ouro, Sul de Moçambique.", ctaPrimary: "Reserve a sua estadia", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes" },
    stay: { headline: "Fique connosco", blurb: "Escolha o seu estilo: tendas na natureza ou chalets e cottage acolhedores – tudo com hospitalidade familiar calorosa.", moreDetails: "Mais detalhes" },
    experiences: { headline: "Experiências", blurb: "Aventuras no oceano e floresta mesmo à porta.", operators: "Operadores locais de confiança:" },
    todo: {
      headline: "O que fazer na Ponta do Ouro",
      note: "Para mergulho, snorkeling, seafaris de golfinhos/baleias e charters de pesca: ver parceiros abaixo.",
      items: [
        { title: "Caminhada ao Farol & Lua Do Mar", body: "Suba ao Farol Antigo para vistas panorâmicas. Continue até ao restaurante Lua Do Mar na duna. Frequentemente golfinhos (ano todo), baleias (mai–out) e tartarugas (dez–jan). Atenção à maré: evite a praia 3h antes até 3h depois da maré alta." },
        { title: "Caminhada a Ponta Malongane", body: "Caminhe pela praia até à aldeia seguinte. A meio, escadas entre bananeiras levam ao Campismo Nino Pub & Restaurant. Perto da transição da baía, um caminho sobe ao Sky Island (parapente). Bares famosos: Drunken Clam e Sunset Shack. Regresso via praia ou estrada 4×4." },
        { title: "Surf, mergulho & investigação oceânica", body: "Aluguer de pranchas no Beach Bar; vários centros de mergulho na aldeia e um centro de pesquisa de golfinhos/baleias." },
        { title: "Comer & relaxar por perto", body: "Há ~16 bares e restaurantes a menos de 500 m do DEVOCEAN. Para uma massagem relaxante, pergunte pela Lisa (LIZ-Way Massage)." },
        { title: "Aluguer de motas de 4 rodas", body: "Alugueres privados ocasionais de locais. Preço indicativo: cerca de MZN 2000 por hora (varia com negociação)." },
      ],
    },
    ...
    location: {
      ...
      items: [
        "Vila de Ponta do Ouro, a curta distância da praia",
    ...
    form: {
      name: "Nome", email: "Email", stayLabel: "Interessado em ficar:", checkin: "De", checkout: "Até",
      unitLabel: "A minha unidade preferida é:",
      units: [
        "Tenda Safari - casa de banho partilhada",
        "Tenda Comfort - casa de banho privada",
        "Cottage Jardim - AC inverter",
        "Chalet de Palha - AC inverter"
      ],
      message: "Mensagem", send: "Enviar",
      consent: "Ao enviar, concorda em ser contactado sobre o seu pedido.",
      phName: "O seu nome", phEmail: "voce@email.com", phMsg: "Conte-nos mais sobre os seus desejos...",
