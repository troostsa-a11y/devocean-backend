...
export const UI = {
  ...
  "pt-PT": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Estadias ecológicas perto de uma praia intocada, num destino de aventura de classe mundial.", description: "Descubra um paraíso único de mergulho UNESCO, rodeado por reservas naturais e experiências inesquecíveis ao ar livre.", ctaPrimary: "Verificar Disponibilidade", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes", whyPonta: "Porquê Ponta do Ouro?" },
  ...
  "pt-BR": {
    ...
    nav: { home: "Início", stay: "Estadia", experiences: "Experiências", todo: "O que fazer", gallery: "Galeria", location: "Localização", contact: "Contacto" },
    hero: { title: "DEVOCEAN Lodge", subtitle: "Hospedagens ecológicas perto de uma praia intocada, em um destino de aventura de classe mundial.", description: "Descubra um paraíso único de mergulho da UNESCO, cercado por reservas naturais e experiências inesquecíveis ao ar livre.", ctaPrimary: "Verificar Disponibilidade", ctaSecondary: "Explore o lodge", badge: "Conforto e valor adorados pelos hóspedes", whyPonta: "Porquê Ponta do Ouro?" },
    stay: { headline: "Fique connosco", blurb: "Escolha o seu estilo: tendas imersas na natureza ou chalés e cottage aconchegantes – tudo com hospitalidade familiar calorosa, como numa machamba local.", moreDetails: "Mais detalhes", ourStory: "A Nossa História" },
    experiences: { headline: "Experiências", blurb: "Aventuras no oceano e na floresta mesmo à sua porta.", operators: "Operadores locais de confiança:" },
    todo: {
      headline: "O que fazer em Ponta do Ouro",
  ...
  sv: {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Miljövänligt boende nära en orörd strand i en äventyrsdestination i världsklass.", description: "Upptäck ett unikt UNESCO-dykparadis, omgivet av naturreservat och oförglömliga upplevelser utomhus.", ctaPrimary: "Kontrollera tillgänglighet", ctaSecondary: "Utforska lodgen", badge: "Gästernas favorit – komfort och värde" },
  ...
  "ja-JP": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "手つかずのビーチのそばで楽しむ、世界級のアドベンチャーデスティネーションにあるエコフレンドリーな滞在。", description: "自然保護区に囲まれた、忘れられないアウトドア体験が待つ、ユネスコ認定の特別なダイビングパラダイスを発見してください。", ctaPrimary: "空き状況を確認", ctaSecondary: "ロッジを探検", badge: "ゲストに愛される快適さと価値" },
  ...
  "zh-CN": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "在世界级探险胜地，享受邻近原始海滩的环保住宿。", description: "探索独一无二的联合国教科文组织潜水天堂，四周环绕自然保护区，并可体验难忘的户外活动。", ctaPrimary: "查看空房", ctaSecondary: "探索旅馆", badge: "深受宾客喜爱的舒适与价值" },
  ...
  "af-ZA": {
    ...
    hero: { title: "DEVOCEAN Lodge", subtitle: "Omgewingsvriendelike verblyf naby 'n ongerepte strand in 'n wêreldklas-avontuurbestemming.", description: "Ontdek 'n unieke UNESCO-duikparadys, omring deur natuurreservate en onvergeetlike buitelugervarings.", ctaPrimary: "Kontroleer beskikbaarheid", ctaSecondary: "Verken die Lodge", badge: "Gerief en waarde, geliefd deur gaste" },
