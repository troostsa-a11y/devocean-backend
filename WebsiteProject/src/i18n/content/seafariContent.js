...
export const SEAFARI_CONTENT = {
  ...
  ru: {
    title: "Морские сафари",
    tagline: "Наблюдение за китами и встречи с морской жизнью",
    overview: "Отправляйтесь в захватывающие морские сафари, чтобы увидеть горбатых китов, мигрирующих через мозамбикские воды (июль-ноябрь). Эти лодочные приключения также предлагают встречи с дельфинами круглый год, сезонные наблюдения за китовыми акулами и снорклинг над нетронутыми рифами, полными морской жизни.",
    highlights: [
      "30 000 горбатых китов (июль-ноябрь)",
      "Прыжки, удары хвостом и спайхоппинг",
      "Встречи с дельфинами круглый год",
      "Китовые акулы (октябрь-март)",
      "Манты и морские черепахи",
      "Снорклинг на нетронутых рифах",
      "Туры под руководством морских биологов",
      "Фокус на исследованиях и охране"
    ],
    pricingRange: "US$40-45 с человека",
    pricingDetails: [
      "Только наблюдение за китами: US$40",
      "Дельфины + киты комбинация: US$45",
      "Частный тур на целый день из Мапуту: US$179",
      "Дети до 12 лет: Сниженные цены",
      "Снаряжение и закуски включены"
    ],
    durationTypical: "2-3 часа",
    durationDetails: [
      "Полудневные экскурсии: 2-3 часа",
      "Полнодневные туры: 6-8 часов (из Мапуту)",
      "Утреннее отправление (лучшие условия)",
      "Включает время для снорклинга",
      "Гибкость в зависимости от активности китов"
    ],
    included: [
      "Лодочный трансфер с опытным капитаном",
      "Снаряжение для снорклинга (маска, ласты, трубка)",
      "Гид-морской биолог (большинство операторов)",
      "Закуски и напитки",
      "Сборы морского парка",
      "Фото/видео (некоторые операторы)",
      "Оборудование безопасности и спасательные жилеты"
    ],
    requirementsLevel: "Все возрасты",
    requirementsDetails: [
      "Особые навыки не требуются для наблюдения за китами",
      "Умение плавать требуется для снорклинга",
      "Возраст: Подходит для семей (дети до пожилых)",
      "Зависит от погоды - море должно быть спокойным",
      "Туры могут быть перенесены при опасных условиях",
      "Теплая куртка рекомендуется (июль-сентябрь)"
    ],
    bestTimePeak: "Июль - Октябрь (Сезон китов)",
    bestTimeDetails: [
      "**Горбатые киты:** Июль-Ноябрь (пик: июл-окт)",
      "**Дельфины:** Круглый год (200+ постоянных)",
      "**Китовые акулы:** Октябрь-Март",
      "**Манты:** Декабрь-Май",
      "**Морские черепахи:** Октябрь-Март (гнездование)",
      "**Самое спокойное море:** Зимние месяцы (июнь-сентябрь)"
    ],
    tips: [
      "Бронируйте в сезон китов (июл-ноя) для лучших шансов",
      "Возьмите теплую куртку - морской бриз может быть холодным",
      "Водонепроницаемая сумка для камеры необходима",
      "Средство от морской болезни при необходимости",
      "Бинокли улучшают опыт наблюдения за китами",
      "Этичные операторы следуют правилам без прикосновений",
      "Наблюдения не гарантированы - дикие животные",
      "Совместите со снорклингом для полного морского опыта"
    ],
    operators: [
      {
        name: "The Dolphin Centre",
        website: "https://thedolphincentre.com/",
        email: "info@thedolphincentre.com",
        specialty: "Эксперты по китам, фокус июль-ноябрь"
      },
      {
        name: "Dolphin Encountours",
        website: "https://www.dolphinencountours.org/",
        email: "info@dolphinencountours.org",
        specialty: "Исследовательские туры, сбор данных для охраны"
      },
      {
        name: "Gozo Azul",
        website: "https://gozo-azul.co.za/",
  ...
  ja: {
    title: "オーシャンサファリ",
    tagline: "ホエールウォッチングと海洋生物との出会い",
    overview: "モザンビーク海域を移動するザトウクジラ（7月〜11月）を見るためにエキサイティングなオーシャンサファリに出かけましょう。これらのボートアドベンチャーでは、年間を通じてイルカとの遭遇、季節限定のジンベエザメ観察、海洋生物でいっぱいの手つかずのリーフでのシュノーケリングも楽しめます。",
    highlights: [
      "30,000頭のザトウクジラ（7月〜11月）",
      "ブリーチング、テールスラップ、スパイホッピング",
      "年間を通じてイルカとの遭遇",
      "ジンベエザメ（10月〜3月）",
      "マンタ＆ウミガメ",
      "手つかずのリーフでシュノーケル",
    ...
    pricingRange: "1人US$40-45",
    pricingDetails: [
      "ホエールウォッチングのみ：US$40",
      "イルカ＋クジラコンボ：US$45",
      "マプトからのプライベート終日ツアー：US$179",
      "12歳未満：割引料金",
      "機材＆軽食込み"
    ],
    ...
    included: [
      "経験豊富なキャプテンによるボート移動",
      "シュノーケル機材（マスク、フィン、シュノーケル）",
      "海洋生物学者ガイド（ほとんどのオペレーター）",
      "軽食＆飲み物",
      "海洋公園料金",
      "写真/ビデオ（一部オペレーター）",
      "安全装備＆ライフジャケット"
    ],
    requirementsLevel: "全年齢対象",
    requirementsDetails: [
      "ホエールウォッチングに特別なスキル不要",
      "シュノーケルには泳力必要",
      "年齢：家族向け（子供から高齢者まで）",
    ...
    bestTimePeak: "7月〜10月（クジラシーズン）",
    bestTimeDetails: [
      "**ザトウクジラ：** 7月〜11月（ピーク：7月〜10月）",
      "**イルカ：** 通年（定住200頭以上）",
      "**ジンベエザメ：** 10月〜3月",
      "**マンタ：** 12月〜5月",
      "**ウミガメ：** 10月〜3月（産卵期）",
    ...
    tips: [
      "クジラシーズン（7月〜11月）に予約がベストチャンス",
      "暖かいジャケット持参 - 海風は冷たい",
      "防水カメラケースは必須",
      "船酔いしやすい方は酔い止めを",
      "双眼鏡でホエールウォッチング体験向上",
      "倫理的なオペレーターはノータッチガイドラインに従う",
      "目撃は保証されない - 野生動物のため",
      "完全な海体験にはシュノーケルと組み合わせ"
    ],
    operators: [
      {
        name: "The Dolphin Centre",
        website: "https://thedolphincentre.com/",
        email: "info@thedolphincentre.com",
        specialty: "クジラ専門家、7月〜11月フォーカス"
      },
      {
        name: "Dolphin Encountours",
        website: "https://www.dolphinencountours.org/",
        email: "info@dolphinencountours.org",
        specialty: "リサーチツアー、保護のためのデータ収集"
      },
      {
        name: "Gozo Azul",
        website: "https://gozo-azul.co.za/",
...
hr: {
      title: "Oceanski safariji",
      tagline: "Posmatranje kitova i susreti sa morskim životom",
      overview: "Krenite na uzbudljive oceanske safarije da vidite grbave kitove kako migriraju kroz mozambičke vode (jul-novembar). Ove avanture čamcem nude i susrete sa dupinima tokom cele godine, sezonska viđenja kitopsinih pasa i snorkeling preko netaknutih grebena punih morskog života.",
      highlights: [
        "30.000 grbavih kitova (jul-novembar)",
        "Skokovi, udaranje repom i spy-hopping",
        "Susreti sa dupinima cele godine",
        "Kitopsini psi (oktobar-mart)",
        "Mante i morske kornjače",
        "Snorkeling na netaknutim grebenima",
        "Ture koje vode morski biolozi",
        "Naglasak na istraživanju i očuvanju"
      ],
      pricingRange: "40-45 US$ po osobi",
      pricingDetails: [
        "Samo posmatranje kitova: 40 US$",
        "Kombinovano dupini + kitovi: 45 US$",
        "Privatna celodnevna tura iz Maputa: 179 US$",
        "Deca ispod 12 godina: snižene cene",
        "Oprema i grickalice uključeni"
      ],
      ...
      durationDetails: [
        ...
        "Celodnevne ture: 6-8 sati (iz Maputa)",
        "Jutarnji polasci (najbolji uslovi)",
        "Uključuje vrijeme za snorkeling",
        "Fleksibilno u zavisnosti od aktivnosti kitova"
      ],
      included: [
        "Prijevoz čamcem sa iskusnim skiperom",
        "Snorkeling oprema (maska, peraja, disaljka)",
        "Vodič morski biolog (većina operatera)",
        "Grickalice i pića",
        "Takse za morski park",
        "Fotografije/snimci (neki operateri)",
      ...
      requirementsDetails: [
        "Posebne veštine nisu potrebne za posmatranje kitova",
        "Veštine plivanja potrebne za snorkeling",
        "Uzrasti: pogodno za porodice (mala deca do starijih)",
        "Zavisno od vrijemena - more mora biti mirno",
        "Ture mogu biti pomerene ako su uslovi nesigurni",
        "Topla jakna preporučena (jul-septembar)"
      ],
      bestTimePeak: "Jul - oktobar (sezona kitova)",
      bestTimeDetails: [
        "**Grbavi kitovi:** jul-novembar (vrhunac: jul-okt)",
        "**Dupini:** tokom cele godine (preko 200 rezidenata)",
        "**Kitopsini psi:** oktobar-mart",
        "**Mante:** decembar-maj",
        "**Morske kornjače:** oktobar-mart (gnežđenje)",
        "**Najmirnija mora:** zimski meseci (jun-septembar)"
      ...
      tips: [
        "Rezervišite u sezoni kitova (jul-nov) za najbolje šanse",
        "Ponesite toplu jaknu - oceanski povetarac može biti hladan",
        "Vodootporna torba za fotoaparat je obavezna",
        "Lekovi za morsku bolest ako ste skloni",
        "Dvogled poboljšava iskustvo posmatranja kitova",
        "Etički operateri poštuju pravila bez dodirivanja",
        "Viđenja nisu garantovana - to su divlje životinje",
        "Kombinujte sa snorkelingom za potpuno morsko iskustvo"
      ],
      operators: [
        {
          name: "The Dolphin Centre",
        ...
        },
        {
          ...
          website: "https://gozo-azul.co.za/",
          email: "info@gozo-azul.co.za",
          specialty: "Oceanski safariji, posmatranje kitova i morski susreti"
        }
      ],
      whaleBehaviors: [
        { name: "Potpuni skok (Breaching)", description: "Potpuna lansiranja tela iz vode - spektakularne demonstracije snage" },
