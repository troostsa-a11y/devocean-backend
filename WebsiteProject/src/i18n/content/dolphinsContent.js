...
export const DOLPHINS_CONTENT = {
  ...
  sv: {
    ...
    overview: "Upplev magiska möten med vilda indo-pacifiska flasknosdelfiner i Ponta do Ouros Partiella Marina Reservat. Båda licensierade operatörerna följer strikta etiska riktlinjer och säkerställer passiva, icke-invasiva interaktioner där delfinerna själva väljer att engagera sig på sina egna villkor.",
    highlights: [
      "Över 200 residenta flasknosdelfiner",
      "Etiska, forskningsbaserade möten",
      "INGEN beröring eller jakt - vilda och fria",
      "Snorkling över orörda rev",
      "Säsongsbetonade valhajsobservationer",
      "Knölvalar (juli-november)",
      "Små grupper (max 12 personer)",
      "Utbildningsfokus på bevarande"
    ],
    pricingRange: "US$45-50 per person",
    pricingDetails: [
      "Delfinobservation (endast båt): US$45",
      "Delfinsimningsutflykt: US$50",
    ...
    requirementsLevel: "Alla åldrar och förmågor",
    requirementsDetails: [
      "Ingen dykererfarenhet krävs",
      "Grundläggande simkunskaper nödvändiga",
      "Alla åldrar (barn välkomna)",
      "Kondition: Lätt till måttlig",
      "Bekväm i havsvatten",
      "Väderberoende - havet måste vara lugnt"
    ],
    bestTimePeak: "Hela året (residenta delfiner)",
    bestTimeDetails: [
      "**Delfiner:** Hela året (200+ residenta)",
      "**Knölvalar:** Juli-november",
      "**Valhajar:** Oktober-mars",
      "**Lugnare Hav:** Tidig morgon",
      "**Vattentemperatur:** 22-28°C hela året"
    ],
    tips: [
      "Boka 2-3 dagar i förväg",
      "Ta med revsäker solkräm",
      "Undervattenskamera rekommenderas",
      "Följ facilitatorns instruktioner noga",
      "Förbli lugn och tyst i vattnet",
      "Låt delfinerna komma till dig naturligt"
    ],
    ethicalPractices: [
      {
        title: "Ingen Beröring eller Jakt",
        description: "Delfiner berörs, jagas eller trakasseras aldrig. Alla möten sker på delfinernas villkor."
      },
      {
      ...
      },
      {
        ...
        description: "Max 12 personer per tur garanterar minimal störning och bättre möten."
      },
      {
        title: "Utbildning Först",
        description: "Briefingar före avresa lär alla deltagare lämpligt beteende och delfinbiologi."
      }
    ],
    operators: [
      {
      ...
      },
      {
        ...
        website: "https://thedolphincentre.com/",
        email: "info@thedolphincentre.com",
        specialty: "Forskningsbaserad delfinsimning med utbildningsfokus"
      }
    ]
  },
  ...
  ru: {
    ...
    tagline: "Этичные встречи с дикими дельфинами в кристально чистых водах",
    overview: "Испытайте волшебные встречи с дикими индо-тихоокеанскими афалинами в Частичном Морском Заповеднике Понта-ду-Оуру. Оба авторизованных оператора следуют строгим этическим нормам, обеспечивая пассивные, неинвазивные взаимодействия, где дельфины сами выбирают участие на своих условиях.",
    highlights: [
      "200+ постоянных афалин",
      "Этичные, основанные на исследованиях встречи",
      "БЕЗ прикосновений или преследований - дикие и свободные",
      "Снорклинг над девственными рифами",
      "Сезонные наблюдения китовых акул",
      "Горбатые киты (июль-ноябрь)",
      "Маленькие группы (макс 12 человек)",
      "Образовательный акцент на сохранение"
    ],
    pricingRange: "US$45-50 на человека",
    pricingDetails: [
      "Наблюдение за дельфинами (только лодка): US$45",
      "Экскурсия плавания с дельфинами: US$50",
      "Многодневные пакеты: Скидочные тарифы",
      "Снаряжение для снорклинга включено",
      "Плата за сохранение включена"
    ],
    durationTypical: "2-3 часа",
    durationDetails: [
      "Ранний утренний старт (лучшие условия)",
      "Снорклинг над мелкими рифами",
      "Фасилитация дельфинов в воде",
      "Встречи с китовыми акулами (сезонные)",
      "Образовательный брифинг перед стартом"
    ],
    included: [
      "Маска, ласты и трубка",
      "Гидрокостюм (при необходимости)",
      "Опытный фасилитатор/гид",
      "Образовательная презентация перед стартом",
      "Фото/видео вашей встречи",
      "Легкие закуски",
      "Сборы морского парка"
    ],
    requirementsLevel: "Все возрасты и способности",
    requirementsDetails: [
      "Требуется умение плавать",
      "Комфортно с снорклингом",
      "Возраст: от 5 до 80+ (погода позволяет)",
      "Беременность: Безопасно до 6 месяцев",
      "Сертификат дайвинга не требуется",
      "Минимум 6 человек на поездку (4 для ретритов)"
    ],
    bestTimePeak: "Январь - Май",
    bestTimeDetails: [
      "**Пиковый Сезон:** Январь-май (лучшие встречи)",
      "**Дельфины:** Круглогодичные жители",
      "**Горбатые Киты:** Июль-ноябрь",
      "**Китовые Акулы:** Октябрь-март",
      "**Самые Спокойные Моря:** Раннее утро",
      "**Температура Воды:** 22-28°C круглый год"
    ],
    tips: [
      "Бронируйте за 2-3 дня",
      "Возьмите безопасный для рифов солнцезащитный крем",
      "Рекомендуется подводная камера",
      "Внимательно следуйте инструкциям фасилитатора",
      "Сохраняйте спокойствие и тишину в воде",
      "Позвольте дельфинам подойти естественно"
    ],
    ethicalPractices: [
      {
        title: "Без Прикосновений или Преследований",
        description: "Дельфинов никогда не трогают, не преследуют и не беспокоят. Все встречи происходят на условиях дельфинов."
      },
      {
        title: "Подход Основанный на Исследованиях",
        description: "Оба оператора работают с морскими биологами и вносят вклад в продолжающиеся исследования и сохранение дельфинов."
      },
      {
        title: "Только Маленькие Группы",
        description: "Максимум 12 человек на поездку обеспечивает минимальное беспокойство и лучшие встречи."
      },
      {
        title: "Образование Прежде Всего",
        description: "Брифинги перед стартом обучают правильному поведению и биологии дельфинов всех участников."
      }
    ],
    operators: [
      {
