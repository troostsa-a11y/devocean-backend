...
export const FISHING_CONTENT = {
  ...
  ru: {
    title: "Береговая и глубоководная рыбалка",
    tagline: "Ловите окуня или охотьтесь на марлина в Мозамбикском проливе",
    overview: "Понта-ду-Ору предлагает исключительную рыбалку как с берега, так и в глубоком море. Теплые воды Индийского океана и глубокий Мозамбикский пролив предоставляют захватывающие возможности для ловли марлина, парусника, ваху, желтоперого тунца и королевской макрели. Береговые рыбаки могут ловить окуня, барракуду и помпано.",
    highlights: [
      "Черный марлин (октябрь-январь)",
      "Парусник (июнь-сентябрь)",
      "Желтоперый тунец и ваху",
      "Королевская макрель (Couta)",
      "Береговая ловля окуня и барракуды",
      "Теплая, кристально чистая вода Индийского океана",
      "Чартеры с запуском с пляжа",
      "Опытные местные капитаны с 20+ летним стажем"
    ],
    pricingRange: "От US$550 (чартер)",
    pricingDetails: [
      "5-часовой чартер: US$550-650",
      "8-часовой чартер: US$850-950",
      "Целый день глубоководной: US$1,000+",
      "Береговая рыбалка: Бесплатно (берите снаряжение)",
      "Береговая с гидом: US$50-100",
      "Лицензии, снаряжение и подготовка включены в чартер"
    ],
    durationTypical: "5-8 часов (чартер)",
    durationDetails: [
      "Полудневной чартер: 5 часов",
      "Полнодневной чартер: 8-10 часов",
      "Береговая рыбалка: Гибко (лучше на рассвете/закате)",
      "Ранний утренний выезд (6-7)",
      "Быстрый доступ к глубокой воде (минуты от берега)"
    ],
    included: [
      "Полное рыболовное снаряжение",
      "Рыболовные лицензии и разрешения",
      "Опытный капитан (20+ лет)",
      "Наживка и приманки",
      "Чистка и разделка рыбы",
      "Вакуумная упаковка для путешествия",
      "Напитки и закуски (большинство операторов)",
      "Оборудование безопасности"
    ],
    requirementsLevel: "От начинающих до продвинутых",
    requirementsDetails: [
      "Опыт не требуется (гиды помогут)",
      "6 рыбаков на лодку (обычно)",
      "Запуск с пляжа - ожидайте промокнуть!",
      "Защита от солнца важна",
      "Умение плавать рекомендуется",
      "Средство от морской болезни при необходимости"
    ],
    bestTimePeak: "Октябрь - Январь (Сезон Марлина)",
    bestTimeDetails: [
      "**Черный марлин:** Октябрь-Январь (пиковый сезон)",
      "**Синий марлин:** Круглый год",
      "**Парусник:** Июнь-Сентябрь (пиковый период)",
      "**Ваху и тунец:** Круглый год (пик: окт-апр)",
      "**Королевская макрель:** Круглый год (лучше: апр-ноя)",
      "**Температура воды:** 22-28°C (теплее = больше пелагических)"
    ],
    tips: [
      "Бронируйте сезон марлина (окт-янв) заранее",
      "Береговая рыбалка лучше на рассвете и закате",
      "Скала в конце пляжа дает глубокую воду",
      "Идите на север к Понта Мамоли для лучшей береговой ловли",
      "Используйте приманки: pink dusters, redeye, кальмары",
      "Возьмите водонепроницаемые сумки для электроники",
      "Договоритесь о хранении рыбы с вашим лоджем",
      "Поймай и отпусти рекомендуется для сохранения марлина"
    ],
    operators: [
      {
        name: "Gozo Azul Fishing",
        website: "",
        email: "info@gozoazulmarine.com",
        specialty: "Капитан Лоренс Коен, 20+ лет опыта"
      },
      {
        name: "Mozambique Fishing Charters",
        website: "",
  ...
  ja: {
    title: "ショア＆ディープシーフィッシング",
    tagline: "パーチを狙うか、モザンビーク海峡でマーリンを追う",
    overview: "ポンタ・ド・オウロは、ビーチからも沖合でも素晴らしい釣りを提供します。暖かいインド洋の海水と深いモザンビーク海峡は、マーリン、バショウカジキ、ワフー、キハダマグロ、キングマッカレルのエキサイティングな機会を提供します。ショアアングラーはパーチ、バラクーダ、ポンパノを狙えます。",
    highlights: [
      "クロマーリン（10月〜1月）",
      "バショウカジキ（6月〜9月）",
      "キハダマグロ＆ワフー",
    ...
    pricingRange: "US$550から（チャーター）",
    pricingDetails: [
      "5時間チャーター：US$550-650",
      "8時間チャーター：US$850-950",
      "終日ディープシー：US$1,000以上",
      "ショアフィッシング：無料（道具持参）",
      "ガイド付きショアフィッシング：US$50-100",
      "ライセンス、道具、準備はチャーターに含まれる"
    ],
    durationTypical: "5-8時間（チャーター）",
    durationDetails: [
      "半日チャーター：5時間",
      "終日チャーター：8-10時間",
      "ショアフィッシング：フレキシブル（夜明け/夕暮れがベスト）",
      "早朝出発（6-7時）",
      "深場への素早いアクセス（海岸から数分）"
    ],
    included: [
    ...
    bestTimePeak: "10月〜1月（マーリンシーズン）",
    bestTimeDetails: [
      "**クロマーリン：** 10月〜1月（ピークシーズン）",
      "**クロカジキ：** 通年",
      "**バショウカジキ：** 6月〜9月（ピーク期間）",
      "**ワフー＆マグロ：** 通年（ピーク：10月〜4月）",
      "**キングマッカレル：** 通年（ベスト：4月〜11月）",
      "**水温：** 22-28°C（暖かいほど回遊魚が多い）"
    ],
    tips: [
      "マーリンシーズン（10月〜1月）は早めに予約",
      "ショアフィッシングは夜明けと夕暮れがベスト",
      "ビーチ端の岩場は深場につながる",
      "より良いショアフィッシングには北のポンタ・マモリへ",
      "ルアー：ピンクダスター、レッドアイ、イカを使用",
      "電子機器用防水バッグ持参",
      "宿泊先と魚の保管を手配",
      "マーリン保護のためキャッチ＆リリース推奨"
    ],
    operators: [
      {
        name: "Gozo Azul Fishing",
        website: "",
        email: "info@gozoazulmarine.com",
        specialty: "キャプテン・ローレンス・コーエン、20年以上の経験"
      },
      {
        name: "Mozambique Fishing Charters",
        website: "",
  ...
  pt: {
    ...
    sr: {
      ...
      overview: "Ponta do Ouro nudi izuzetan ribolov i sa plaže i u dubokom moru. Tople vode Indijskog okeana i dubine Mozambičkog kanala pružaju uzbudljive prilike za marlina, sabljarku, vahua, žutoperajnu tunu i kraljevsku skušu. Ribolovci sa plaže mogu uloviti kingfish, barakude i pampano sa netaknutih obala.",
      highlights: [
        ...
        "Tople, čiste vode Indijskog okeana",
      ...
      durationDetails: [
        ...
        "Brz pristup dubokoj vodi (na nekoliko minuta od obale)"
      ],
      included: [
