...
export const DIVING_CONTENT = {
  ...
  ru: {
    title: "Дайвинг",
    tagline: "Исследуйте нетронутые рифы с бычьими акулами, мантами и китовыми акулами",
    overview: "Понта-ду-Ору предлагает дайвинг мирового класса с более чем 20 дайв-сайтами от мелководных рифов до глубоких пиннаклей. Кристально чистые воды Мозамбикского пролива обеспечивают отличную видимость и встречи с невероятным разнообразием морской жизни, включая 19 видов акул.",
    highlights: [
      "20+ дайв-сайтов от 8м до 48м",
      "Бычьи акулы, тигровые акулы и молот-рыбы",
      "Китовые акулы (октябрь-март)",
      "Горбатые киты (июль-ноябрь)",
      "Манты, черепахи и дельфины",
      "180+ видов голожаберных",
      "Нетронутые коралловые рифы",
      "Профессиональные центры PADI"
    ],
    pricingRange: "От US$40 за погружение",
    pricingDetails: [
      "Одно погружение: US$40-50",
      "Пакет из двух погружений: US$75-90",
      "PADI Open Water: US$350-400",
      "Аренда снаряжения включена",
      "Все лицензии и разрешения включены"
    ],
    durationTypical: "Полдня или целый день",
    durationDetails: [
      "Утренние погружения: 2 погружения (3-4 часа)",
      "Целый день: 3 погружения (6-8 часов)",
      "Запуск с пляжа (захватывающе!)",
      "Сайты в 1-12 км от берега"
    ],
    included: [
      "Полное дайв-снаряжение (BCD, регулятор, костюм)",
      "Лодочный трансфер к дайв-сайтам",
      "Профессиональный инструктор PADI/дайвмастер",
      "Сборы морского парка",
      "Закуски и напитки после погружения",
      "Дайв-компьютер и оборудование безопасности"
    ],
    requirementsLevel: "От начинающих до продвинутых",
    requirementsDetails: [
      "Сайты для начинающих: Crèche, Doodles, Playground (10-18м)",
      "Продвинутые сайты: Pinnacles, Atlantis, Cloudbreak (28-48м)",
      "Требуется сертификат PADI (или пройдите курс Open Water)",
      "Требуется медицинская справка",
      "Комфортное умение плавать",
      "Минимальный возраст: 10 лет (Junior Open Water)"
    ],
    bestTimePeak: "Октябрь - Апрель (Лето)",
    bestTimeDetails: [
      "**Бычьи и тигровые акулы:** Ноябрь-Апрель (вода 26-29°C)",
      "**Молот-рыбы:** Апрель-Октябрь (лучшая видимость)",
      "**Китовые акулы:** Октябрь-Март",
      "**Горбатые киты:** Июль-Ноябрь",
      "**Лучшая видимость:** Май-Август (20-30м)",
      "**Самая теплая вода:** Декабрь-Февраль (27-29°C)"
    ],
    tips: [
      "Бронируйте заранее в пиковый сезон (декабрь-январь)",
      "Возьмите свою сертификационную карту",
      "Подумайте о гидрокостюме (рекомендуется 3мм)",
      "Запуск через прибой может быть захватывающим - приготовьтесь промокнуть!",
      "Большинство операторов предоставляют аренду снаряжения",
      "Пакеты с несколькими погружениями предлагают лучшую цену"
    ],
    operators: [
      {
        name: "Back to Basics Adventures",
        website: "http://www.backtobasicsadventures.com/",
        email: "backtobasicsadventures@gmail.com",
        specialty: "Специалисты по дайвингу с акулами, ориентированы на исследования"
      },
      {
        name: "Gozo Azul Diving",
        website: "https://gozo-azul.co.za/",
        email: "natalie@gozo-azul.co.za",
        specialty: "5-звездочный центр PADI, специалисты по дайвингу с акулами"
      },
      {
        name: "Under Water Explorer",
        website: "",
      ...
      },
      {
        ...
        website: "",
        email: "info@sharkdivingmozambique.com",
        specialty: "Специалисты по дайвингу с акулами"
      },
      {
        name: "Oceana Dive Center",
        website: "",
  ...
  pt: {
    ...
    sr: {
      ...
      bestTimePeak: "Oktobar - April (leto)",
      bestTimeDetails: [
