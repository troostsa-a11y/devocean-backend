        ...
        <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="border border-white/40 rounded px-2 py-1 w-[76px] sm:w-[140px] text-white"
            ...
            <select
              ...
              className="border border-white/40 rounded px-2 py-1 w-[50px] sm:w-[93px] text-white"
