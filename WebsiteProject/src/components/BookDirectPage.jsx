...
import { CalendarCheck2, Users, Loader2, ShieldCheck, ChevronLeft } from 'lucide-react';
...
export default function BookDirectPage({ lang = 'en-GB', countryCode }) {
    ...
    <main className="flex-1 bg-slate-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <header className="mb-8 text-center">
          <h1 className="text-3xl sm:text-4xl font-bold text-slate-900" data-testid="text-booking-title">
            {t.title}
          </h1>
          <p className="mt-3 text-slate-600 max-w-xl mx-auto">{t.subtitle}</p>
        </header>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <label className="block">
                <span className="text-sm font-medium text-slate-700">{t.checkIn}</span>
                <input
                  type="date"
                  value={checkIn}
                  min={todayStr()}
              ...
              <label className="block">
                <span className="text-sm font-medium text-slate-700">{t.checkOut}</span>
                <input
                  type="date"
                  value={checkOut}
              ...
              <label className="block">
                <span className="text-sm font-medium text-slate-700">{t.adults}</span>
                <select
                  value={adults}
                  onChange={(e) => setAdults(parseInt(e.target.value, 10))}
                  className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2.5 bg-white focus:border-[#9e4b13] focus:ring-1 focus:ring-[#9e4b13] outline-none"
              ...
              <label className="block">
                <span className="text-sm font-medium text-slate-700">{t.children}</span>
                <select
                  value={children}
