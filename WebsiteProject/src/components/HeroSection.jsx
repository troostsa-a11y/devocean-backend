  ...
  return (
    <section id="home" className="relative overflow-hidden min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-white w-full pb-6 sm:pb-24 pt-[calc(var(--header-h)_-_1rem)] sm:pt-[calc(var(--header-h)_+_4rem)]">
        <h1 className="mt-14 font-bold max-w-3xl leading-tight sr-only sm:not-sr-only [@media_(max-height:700px)_and_(min-width:640px)]:hidden" style={{ fontSize: 'var(--hero-h1-size, clamp(3.5rem, 14vw, 3.75rem))' }}>{ui.hero.title}</h1>
