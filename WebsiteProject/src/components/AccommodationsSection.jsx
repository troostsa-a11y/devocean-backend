...
const getFeatureLabel = (feature, lang) => {
  const labels = {
    fan: { en: 'Fan', pt: 'Ventilador', nl: 'Ventilator', fr: 'Ventilateur', it: 'Ventilatore', de: 'Ventilator', es: 'Ventilador', af: 'Waaier', sv: 'Fläkt', pl: 'Wentylator', ro: 'Ventilator', ja: 'ファン', zh: '风扇', ru: 'Вентилятор', zu: 'Ifeni', sw: 'Feni' },
    terrace: { en: 'Terrace', pt: 'Terraço', nl: 'Terras', fr: 'Terrasse', it: 'Terrazza', de: 'Terrasse', es: 'Terraza', af: 'Terras', sv: 'Terrass', pl: 'Taras', ro: 'Terasă', ja: 'テラス', zh: '露台', ru: 'Терраса', zu: 'Iterasi', sw: 'Terasi' },
    shared: { en: 'Shared Bath', pt: 'WC Partilhado', nl: 'Gedeelde Badkamer', fr: 'Salle de bain partagée', it: 'Bagno condiviso', de: 'Gemeinschaftsbad', es: 'Baño compartido', af: 'Gedeelde Bad', sv: 'Delat badrum', pl: 'Wspólna łazienka', ro: 'Baie comună', ja: '共用バス', zh: '共用浴室', ru: 'Общая ванная', zu: 'Ibhafu elabelwana', sw: 'Bafu ya pamoja' },
    ensuite: { en: 'En-suite', pt: 'WC Privativo', nl: 'Eigen Badkamer', fr: 'Salle de bain privée', it: 'Bagno privato', de: 'Eigenes Bad', es: 'Baño privado', af: 'Privaat Bad', sv: 'Eget badrum', pl: 'Łazienka prywatna', ro: 'Baie privată', ja: '専用バス', zh: '独立浴室', ru: 'Собственная ванная', zu: 'Ibhafu langasese', sw: 'Bafu ya faragha' },
    ac: { en: 'A/C', pt: 'Ar Condicionado', nl: 'Airco', fr: 'Climatisation', it: 'Aria condizionata', de: 'Klimaanlage', es: 'Aire acondicionado', af: 'Lugversorging', sv: 'AC', pl: 'Klimatyzacja', ro: 'Aer condiționat', ja: 'エアコン', zh: '空调', ru: 'Кондиционер', zu: 'I-AC', sw: 'Kiyoyozi' },
    queen: { en: 'Queen Bed', pt: 'Cama Queen', nl: 'Queensize Bed', fr: 'Lit Queen', it: 'Letto Queen', de: 'Queen-Bett', es: 'Cama Queen', af: 'Queen Bed', sv: 'Queen-säng', pl: 'Łóżko Queen', ro: 'Pat queen', ja: 'クイーンベッド', zh: '大床', ru: 'Двуспальная кровать', zu: 'Umbhede weQueen', sw: 'Kitanda cha Queen' },
    secluded: { en: 'Secluded', pt: 'Isolado', nl: 'Afgelegen', fr: 'Isolé', it: 'Appartato', de: 'Abgeschieden', es: 'Aislado', af: 'Afgesonderd', sv: 'Avskilt', pl: 'Ustronny', ro: 'Retras', ja: '隠れ家', zh: '隐蔽', ru: 'Уединённый', zu: 'Okuhlukanisiwe', sw: 'Faragha' }
  };
