...
const getFeatureLabel = (feature, lang) => {
  const labels = {
    ...
    ac: { en: 'A/C', pt: 'Ar Condicionado', nl: 'Airco', fr: 'Climatisation', it: 'Aria condizionata', de: 'Klimaanlage', es: 'Aire acondicionado', af: 'Lugversorging', sv: 'AC', pl: 'Klimatyzacja', ro: 'Aer condiționat', sr: 'Klima', hr: 'Klima', cs: 'Klimatizace', tr: 'Klima', ja: 'エアコン', zh: '空调', ru: 'Кондиционер', zu: 'I-AC', sw: 'Kiyoyozi' },
