  ...
  return (
    <section id="stay" className="max-w-7xl mx-auto px-4 py-16">
      <div className="flex items-end justify-between gap-6">
        ...
        <a
          href="/story.html"
          className={`btn-cta hidden md:inline-block w-[12rem] text-center ${lang === 'ru' || lang === 'zu' ? 'px-3 py-1.5 text-sm' : 'px-4 py-2'} rounded-xl bg-[#9e4b13] text-white whitespace-nowrap`}
