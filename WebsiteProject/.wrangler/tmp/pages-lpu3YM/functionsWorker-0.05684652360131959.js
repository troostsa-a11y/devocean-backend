...
var autoReplySubjects = {
  ...
  fr: "\u2705 Merci d'avoir contact\xE9 DEVOCEAN Lodge",
  de: "\u2705 Vielen Dank f\xFCr Ihre Kontaktaufnahme mit DEVOCEAN Lodge",
  ...
  tr: "\u2705 DEVOCEAN Lodge ile ileti\u015Fime ge\xE7ti\u011Finiz i\xE7in te\u015Fekk\xFCrler",
  sv: "\u2705 Tack f\xF6r att du kontaktade DEVOCEAN Lodge",
...
${sanitizedMessage}`;
    ...
    await sendEmail2(
      "reservations@devoceanlodge.com",
      sanitizedOperatorEmail,
      `Experience Inquiry: ${sanitizedExperience}`,
      operatorEmailHtml,
      env.RESEND_API_KEY,
      sanitizedEmail,
      bccEmail
    ...
    await sendEmail2(
      "reservations@devoceanlodge.com",
      sanitizedEmail,
      autoReplySubjects2[sanitizedLang] || autoReplySubjects2.en,
      autoReplyHtml,
      env.RESEND_API_KEY,
      "reservations@devoceanlodge.com"
    );
...
// ../.wrangler/tmp/pages-lpu3YM/functionsRoutes-0.5832124478637237.mjs
var routes = [
  {
