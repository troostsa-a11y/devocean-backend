...
(function(){
  ...
  // Set header height on load and keep it fresh
  function updateHeaderHeight(){
    if (header) {
      const height = header.offsetHeight;
      document.documentElement.style.setProperty('--header-height', height + 'px');
  ...
  setTimeout(function() {
    ...
    if (linksContainer){
      ...
      navigationReady = true; // Enable navigation immediately after wiring
    }
    ...
    // On load with hash - do instant correction first
    if (window.location.hash){
      ...
      setTimeout(()=>{
        ...
        // Enable observer and navigation right away
        observerEnabled = true; 
        navigationReady = true;
      }, 0);
    } else {
      // No hash: enable immediately
      observerEnabled = true; 
      navigationReady = true;
    }
