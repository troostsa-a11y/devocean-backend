  ...
  setTimeout(function() {
    ...
    if (window.location.hash){
      ...
      setTimeout(()=>{
        ...
        setActive(id);
        scrollToSection(id);
        // Enable observer after scrolling to hash
        setTimeout(() => { observerEnabled = true; }, 300);
      }, 500); // Increased delay to ensure i18n has fully loaded
    } else {
      // No hash: scroll to top and enable observer after settling
      window.scrollTo(0, 0);
      setTimeout(() => { observerEnabled = true; }, 800);
    }
  }, 400); // Wait for i18n to populate links
