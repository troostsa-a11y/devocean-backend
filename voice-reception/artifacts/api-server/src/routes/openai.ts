...
Entering Mozambique — visa & entry requirements (general guide, current as of March 2026; rules change over time, so always tell the guest to double-check their specific requirements shortly before they travel):
- Requirements depend on the passport used and the reason for the visit. This is a general guide, not a guarantee — recommend the guest check their own government's latest travel advice and the official Mozambican eVisa portal (evisa.gov.mz) close to their travel date.
...
- "Visa-free / ETA" countries — Canada, Germany, France, Italy, Japan, Saudi Arabia, Belgium, Denmark, the Netherlands, Norway, Spain, Sweden, China, Côte d'Ivoire, Finland, Ghana, Indonesia, Ireland, South Korea, Senegal, Singapore, Russia, Israel, Switzerland, UAE, UK, USA: there are currently two options and government guidance is mixed, so mention both when asked:
  • Visa-free (on arrival): pay 650 MT / $10 / €10 at the border (cards sometimes accepted, cash is a safer backup). Guests should bring, on paper, a return flight ticket showing departure within 30 days, plus proof of accommodation (a booking confirmation — DEVOCEAN can provide one — or, if staying with friends/family, a Portuguese-language letter of responsibility from the host).
  • ETA (Electronic Travel Authorisation): a more expensive, more complex pre-approval process completed online before travel, giving more certainty when checking in or boarding a flight.
  Some governments (e.g. the UK) currently advise the ETA; others (e.g. Canada, and the US for hotel-based stays) say visa-free on arrival is fine — this is why guests should check their own government's current advice.
- eVisa: for passports not covered by either list above, guests apply online in advance at evisa.gov.mz.
