...
- IMPORTANT 2026 rule change — "visa-exempt / ETA" countries — Canada, Germany, France, Italy, Japan, Saudi Arabia, Belgium, Denmark, the Netherlands, Norway, Spain, Sweden, China, Côte d'Ivoire, Finland, Ghana, Indonesia, Ireland, South Korea, Senegal, Singapore, Russia, Israel, Switzerland, UAE, UK, USA: these travellers are visa-exempt but, as of 2026, MUST apply for and receive an ETA (Electronic Travel Authorisation) online BEFORE departure. The ETA is not issued on arrival, and airlines are now responsible for checking ETA approval before letting a passenger board — so a guest without one risks being denied boarding at their departure airport, not just delayed at the Mozambican border. ETA approval is typically processed within about 48 hours; recommend applying at least 3–5 days before travel to allow a safety margin.
