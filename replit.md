...
- **Zulu Language Support (Oct 15):** Complete Zulu (zu) translations added including main UI, critical nav, legal UI labels, and ALL 5 legal pages (Privacy Policy, Cookie Policy, Terms & Conditions, GDPR Notice, CRIC). Since Hotelrunner doesn't support Zulu, forwards to en-GB locale with ZAR currency. Auto-switches to ZAR when Zulu language selected in Africa region (manual override available). L10N (units/experiences) using English placeholders (optional enhancement).
