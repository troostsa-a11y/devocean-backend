...
- **Zulu Language Support (Oct 15):** Complete Zulu (zu) translations added including main UI, critical nav, legal UI labels, and Privacy Policy. Since Hotelrunner doesn't support Zulu, forwards to en-GB locale with ZAR currency. Auto-switches to ZAR when Zulu language selected in Africa region (manual override available). L10N (units/experiences) using English placeholders. Remaining legal pages (Cookies, Terms, GDPR, CRIC) ready for future translation.
