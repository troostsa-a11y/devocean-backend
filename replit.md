...
- **Internationalization:**
    ...
    - **Unified Language Codes (Oct 19, 2025):** ALL systems use identical Hotelrunner locale codes throughout: `en-GB`, `en-US`, `pt-PT`, `pt-BR`, `nl-NL`, `fr-FR`, `it-IT`, `de-DE`, `es-ES`, `ja-JP`, `zh-CN`, `af-ZA` (NOT base codes like nl, fr, de, es, ja, zh). Single unified system across: React app (useLocale.js), vanilla JS i18n (story-i18n.js, accommodation-detail-i18n.js), translation files (translations.js, critical.js, story JSON), Header.jsx, booking URLs, localStorage, and server-side email.
